...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'test_large_file_write.data';
      var REMOTE_PACKAGE_BASE = 'test_large_file_write.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_test_large_file_write.data');

      };
      Module['addRunDependency']('datafile_test_large_file_write.data');
   ...
   loadPackage({"files": [{"filename": "/random-text.txt", "start": 0, "end": 10485760}], "remote_package_size": 10485760, "package_uuid": "de66c2e9-a9ab-4b26-9cf9-397514686289"});
...
var wasmBinaryFile;
  wasmBinaryFile = 'test_large_file_write.wasm';
...
var ASM_CONSTS = {
  1992: function() {console.time("Func #1")},  
 2016: function() {console.timeEnd("Func #1")}
};
