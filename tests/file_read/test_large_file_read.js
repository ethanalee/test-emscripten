...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'test_large_file_read.data';
      var REMOTE_PACKAGE_BASE = 'test_large_file_read.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_test_large_file_read.data');

      };
      Module['addRunDependency']('datafile_test_large_file_read.data');
   ...
   loadPackage({"files": [{"filename": "/random-text.txt", "start": 0, "end": 10485760}], "remote_package_size": 10485760, "package_uuid": "f747da7e-cac4-49cf-9555-077542d363b3"});
...
var wasmBinaryFile;
  wasmBinaryFile = 'test_large_file_read.wasm';
...
var ASM_CONSTS = {
  1052: function() {console.time("Func #1")},  
 1076: function() {console.timeEnd("Func #1")}
};
